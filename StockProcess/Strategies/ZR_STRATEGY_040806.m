function outputdata=ZR_STRATEGY_040806(inputdata)
...
%==========================================================================
outInteger=TA_CDLABANDONEDBABY(inputdata.commodity.serialmkdata.op,inputdata.commodity.serialmkdata.hp,inputdata.commodity.serialmkdata.lp,inputdata.commodity.serialmkdata.cp,inputdata.strategyparams.Penetration);
%==========================================================================
...
l_realtradeday=find(outInteger);
