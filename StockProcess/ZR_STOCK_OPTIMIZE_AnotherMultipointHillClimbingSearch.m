function ZR_STOCK_OPTIMIZE_AnotherMultipointHillClimbingSearch(varargin)
% 网格计算，参数配对
...
%     disp('参数组合太多，目前限制为10000，如果确实需要，请修改ZR_STOCK_OPTIMIZE_GridSearch中的限制！');
%     return;
% end
...
for l_point = 1 : l_numberOfStartingpoints
    ...
    l_commandstr=strcat(' ZR_STOCK_PROCESS_RecordOptimization(',l_parmstr,'); ');
