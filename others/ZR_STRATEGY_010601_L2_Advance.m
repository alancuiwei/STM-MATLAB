function ZR_STRATEGY_010601_L2_Advance(varargin)
% 羽根英树的策略:010601
...
g_strategydata(in_pairid).case2a.ismatched=(g_strategydata(in_pairid).type>=(g_commodityparams.period-1));
...
g_strategydata(in_pairid).type=g_strategydata(in_pairid).type+1*((g_strategydata(in_pairid).case2a.ismatched|g_strategydata(in_pairid).case2b.ismatched...
    |g_strategydata(in_pairid).case2c.ismatched)&g_indicatordata.pair(in_pairid).serial);
