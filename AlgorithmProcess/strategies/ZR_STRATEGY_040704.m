...
%     outputdata.record.ctname(PositionInTrade)=inputdata.commodity.serialmkdata.ctname(ForceTrade(i)+1);
end
%==========================================================================
