        ...
        case '01'
            switch l_rightid(7:8)
                ...
                case '02'
                    ...
                    l_months=ZR_FUN_QueryDeliverMonths(l_strategyinfo.firstcommodityid{l_id});
                    l_contractnames=ZR_FUN_QueryContractnames(l_strategyinfo.firstcommodityid{l_id},cell2mat(l_months));
